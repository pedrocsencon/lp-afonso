...
import headerBg from '../assets/top-bg.png'
    ...
    return (
        <Box width={'100%'} alignItems='center'>
            ...
            <Flex paddingBottom={12} id='background' direction='column' width='100%' alignItems={'center'} justify='center'>
                ...
                <Box marginTop={8} width='60%'>
                    <Image alt="afonsod1" src={logo} />
                </Box>
                <Stack spacing={4} marginTop={8} alignItems='center' textAlign='center' width={'100%'}>
                    <Stack spacing={0}>
            ...
            <Box>
                <Image alt="headerbg" src={headerBg} />
            </Box>
            <Box textAlign={'center'} alignItems='center' padding={6} width={'100%'} backgroundColor='#f3f3f3'>
                <Text fontSize='xl' fontWeight='bold'>
                    Tudo pode mudar em 7 semanas
                </Text>
                <Stack borderRadius={24} marginTop={4} spacing={4} backgroundColor={'white'} padding={4} alignItems='center' textAlign='center'>
            ...
            <Box id='texture' width={'100%'} bgColor={'white'} padding={4} backgroundColor='orange.400'>
            ...
            <Stack spacing={8} padding={6} alignItems='center' textAlign='center'>
                ...
                <Stack spacing={6} padding={4} borderRadius={12} bgColor={'white'} shadow='2xl'>
                    <Text>
            ...
            <Stack width={'100%'} paddingX={8} alignItems='center' textAlign={'center'} spacing={8}>
                ...
                <Text>
                    Mas essa é a primeira turma online do <Text fontWeight={'extrabold'} fontSize='lg' textDecor={'underline'} textUnderlineOffset={2} textDecorationColor='orange.500'>Efeito Posicionado,</Text><strong>então eu decidi ir além</strong>.
                </Text>
                <Text>
                ...
                <Button size={'lg'} colorScheme='orange' paddingX={12} height={'60px'}>
                    QUERO VENDER MUITO
                </Button>
            </Stack>
            <Box marginY={8} width={'100%'} height={12} bgColor='orange.500' />
            <Stack padding={8}>
                <Box>
                    <Image alt="selo" src={selo} />
                </Box>
                <Flex direction='column' alignItems='center'>
                    <Box zIndex={50} width={'75%'}>
                        <Image alt="afonsocelular" src={afonsoCelular} />
                    </Box>
                    <Box marginTop={-50} bgColor={'gray.100'} shadow={'lg'} textAlign='center' paddingTop={16} paddingBottom={6} paddingX={6} borderRadius={12}>
                        <Text fontSize={'sm'}>
                            Meu nome é Afonso Molina, eu ganhei mais de 180 mil seguidores em apenas 7 meses. Quando eu entendi como o Instagram funcionava, a minha vida mudou. Fui de um negócio falido e um volume incontável de dívidas para ter uma empresa de sucesso em menos de 2 anos, agora, vou te mostrar como você também pode mudar a sua vida com essa ferramenta.
                        </Text>
                    </Box>
                </Flex>
            </Stack>
